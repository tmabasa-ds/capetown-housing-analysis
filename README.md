...
Cape Town has 26,877 Airbnb listings. 82.6% of them are entire homes - not spare rooms, entire properties withdrawn from the long-term rental market. The median listing costs R1,526 per night, or roughly R45,780 a month. The median monthly salary in the Western Cape is approximately R8,500.
...
- **Woodstock**, historically a working-class coloured neighbourhood, now has 412 listings at a median monthly equivalent of R27,930 - in an area where long-term rents were R4,000-6,000 a decade ago
...
Download the data:
- `listings.csv` from [insideairbnb.com/cape-town](http://insideairbnb.com/cape-town) - select the most recent date and download `listings.csv.gz`, then unzip
